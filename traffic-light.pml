...
// Process that marks all the directions[0] as should_be_open
proctype MarkAsShouldBeopen() {
    do
    :: !directions[0].should_be_open && !directions[1].should_be_open && !directions[2].should_be_open &&       
	!directions[3].should_be_open && !directions[4].should_be_open && !directions[5].should_be_open -> {
           directions[0].should_be_open = 1; directions[1].should_be_open = 1; directions[2].should_be_open = 1;
           directions[3].should_be_open = 1; directions[4].should_be_open = 1; directions[5].should_be_open = 1;
       }
    od
}
